...
<script>
import {getMobileCode,getEmailCode,register,registerByMobile,registerByEmail} from "@/service/index";
...
export default {
  ...
  mounted() {
    let code = this.GetQueryString('invite_code') || '';
    if(code.length > 0){
...
.login {
  ...
  .form {
    ...
    .btn {
      ...
      box-shadow: 0 .02rem .04rem 0 rgba(75, 131, 243, 0.4);
      border-radius: .1rem;
      font-family: PingFangSC-Regular;
      font-size: .16rem;
      color: #ffffff;
...
.van-button__text{font-size: .14rem}
</style>
